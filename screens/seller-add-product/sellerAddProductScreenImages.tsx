...
const SellerAddProductScreenImages = ({ route, navigation, props }) => {
    const { t, i18n } = useTranslation();
    const navigate = useNavigation();
    const [user_data, setUserData] = useState();
    const { step_one, step_two, step_three, totalQuantity } = route.params;
    ...
    const signOutSeller = async () => {
     ...
     const onSubmit = async () => { 
        ...
        try {  
            ...
            formData.append('product_gallery', photos);
...
export default SellerAddProductScreenImages;